...
class TwoLayerNet(object):
    """
    A two-layer fully-connected neural network with ReLU nonlinearity and  两层的全连接神经网络
    softmax loss that uses a modular layer design. We assume an input dimension
    of D, a hidden dimension of H, and perform classification over C classes.
    The architecure should be affine - relu - affine - softmax.  #relu是激活函数
    ...
    def __init__(
        ...
        #初始化两层网络的权重和偏差。权重应从以0.0为中心的高斯初始化，标准偏差等于weight_scale，偏差应初始化为零。所有权重和偏差应存储在字典中。参数，第一层权重和偏差使用键“W1”和“b1”，第二层权重和偏差使用键“W2”和“b2”。
        ############################################################################
    ...
    def loss(self, X, y=None):
        ...
        b1 = self.params['b1']
        W2 = self.params['W2']
        b2 = self.params['b2']  # 目的是为了预测不同样本的类别因此我们还需要编写一个预测函数，同样选择每一类中得分函数最大的为该样本的类
